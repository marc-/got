...
public class ListSpellsCommandTest {
  ...
  public void testIssue() {
    ...
    new ListSpellsCommand().issue(context);
    verify(printStream, times(1)).println(eq(MessageType.GAME.wrap(TestHelper.PLAYER.describeAbilities())));
  }
